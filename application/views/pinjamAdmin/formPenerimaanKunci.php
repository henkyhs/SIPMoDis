<div class="container mt-4">
    ...
    <!-- Data Pengembalian -->
     <div class="card shadow mb-4">
        ...
        <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
        role="button" aria-expanded="true" aria-controls="collapseCardExample">
        <h6 class="m-0 font-weight-bold text-primary">Data Pengembalian <?= $pinjam->idPeminjaman?></h6>
        </a>
        <!-- Card Content - Collapse -->
        <div class="collapse show" id="collapseCardExample">
             <div class="card-body">
                  <dl class="row mb-0">
                    ...
                    <dt class="col-5 text-secondary">Kondisi Bensin Saat Dikembalikan</dt>
                    <dd class="col-7"><?= htmlspecialchars(bensin_peminjam($pinjam->bensinPemakaian) ?? '-'); ?></dd>

                    <dt class="col-5 text-secondary">Catatan Peminjam</dt>
                    <dd class="col-7"><?= nl2br(htmlspecialchars($pinjam->catatanPeminjam ?? '-')); ?></dd>
    ...
    <?php endif; ?>
    <form action="<?= site_url('peminjaman/penerimaanKunci/'.$pinjam->idPeminjaman); ?>" method="post">
		<!-- Input Perlengkapan -->
     <div class="form-group">
            <label>Pengecekkan Perlengkapan</label>
            <small class="text-muted d-block mb-1">Sesuaikan Perlengkapan</small>
             <?php if (!empty($perlengkapan)) : ?>
                <?php foreach ($perlengkapan as $p) : ?>
      ...
      <div class="form-group">
            <label>Cek Kondisi Bensin</label>
