<div class="container mt-4">
    ...
    <form action="<?= site_url('peminjaman/savePengajuan/'); ?>" method="post" enctype="multipart/form-data">
        ...
        <a href="<?= site_url('peminjaman/PenolakanPengajuan/'.$pinjam->idPeminjaman) ?>" class="btn btn-danger btn-block" onclick="return confirm('Yakin untuk menolak pengajuan?')">Tolak Pengajuan</a>
