<div class="container-fluid  mt-4">
  ...
  <div class="row">
    ...
    <!-- RIGHT: Detail Mobil + Perlengkapan + Timeline + Catatan -->
    <div class="col-lg-8">
          ...
          <?php if (!empty($pinjam->idMobil)): ?>
            <div class="row">
              <div class="col-md-6 mb-2">
                ...
                <div class="font-weight-bold"><?= htmlspecialchars($pinjam->merk ?? '-') ?> <?= htmlspecialchars($pinjam->namaMobil ?? '') ?></div>
              </div>
              <div class="col-md-6 mb-2">
                <div class="text-muted small">Transmisi</div>
                <div class="font-weight-bold"><?= htmlspecialchars($pinjam->transmisi ?? '-') ?></div>
              </div>
            </div>
          <?php else: ?>
                  ...
                  <?php foreach ($pinjamPerlengkapan as $p): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <?= ((int)$p->isDikembalikan === 1) ? "<span class='badge badge-success'>Ya</span>" : "<span class='badge badge-danger'>Tidak</span>" ?>
                      </td>
                      <td class="text-center">
                        <?= ((int)$p->isAda === 1) ? "<span class='badge badge-success'>Ya</span>" : "<span class='badge badge-warning'>Tidak Ada </span>" ?>
                      </td>
                      <!-- <td class="text-center">
                        <?php
                          $ok = ((int)$p->isDikembalikan === (int)$p->isAda);
                          echo $ok
